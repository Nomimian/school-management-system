...
export default function Calendar() {
  ...
  // Compare date-only (events are stored at UTC midnight) so TODAY's events stay in Upcoming.
  const upcoming = events.filter(e=>(e.date?.slice(0,10)||'')>=todayStr).sort((a,b)=>(a.date||'').localeCompare(b.date||'')).slice(0,8);
